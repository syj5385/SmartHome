...
public class Command {
    ...
    public static final int NEW_TOKEN = 17;
    ...
    public static byte[] request_blescan_toServer(){
    ...
    public static byte[] request_isFinished_BleScan_toServer(){
    ...
    public static byte[] request_addDevice_toServer(int device_type,String name, String mac){
    ...
    public static byte[] request_removeDevice_toServer(int removed_ID){
    ...
    public static byte[] request_isFinished_AddDevice_toServer(){
    ...
    public static byte[] request_current_Device_to_Server(){
    ...
    public static byte[] request_hello_android_to_Server(){
        List<Byte> packet = requestPacket(HELLO_ANDROID);
        Log.d("Command","packet size  : " + packet.size());
    ...
    public static byte[] request_current_Device_to_Server(int id){
    ...
    public static byte[] request_execute_toServer(Device device){
    ...
    public static byte[] request_add_new_FCM_Token(String token){
        Character[] payload = new Character[token.length()];
        int index =0 ;


        for(int j=0; j<token.length() ; j++){
            payload[index++] = token.charAt(j);
        }

        List <Byte> packet = requestPacket(Command.NEW_TOKEN,payload);
        byte[] arr = new byte[packet.size()];
