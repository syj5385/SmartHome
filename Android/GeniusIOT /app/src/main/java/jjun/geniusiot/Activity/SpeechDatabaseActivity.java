...
import jjun.geniusiot.SpeechRecognizer.InsertSpeechDB_Dialog;
import jjun.geniusiot.SpeechRecognizer.SpeechDB;
...
public class SpeechDatabaseActivity extends AppCompatActivity {
    ...
    private int getCommandUsingExecution(int execution){
        ...
        switch(execution){
            ...
            case 14 :
                command_result = SpeechProcessManager.REQUEST_CURRENT_TEMPERATURE;
                break;
